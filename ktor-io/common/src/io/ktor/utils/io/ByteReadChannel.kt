...
public expect interface ByteReadChannel {
     ...
     */
    public suspend fun readAvailable(destination: ByteArray, offset: Int = 0, length: Int = destination.size): Int

    /**
     * Reads all [length] bytes to [destination] buffer or fails if channel has been closed.
     * Suspends if not enough bytes available.
     */
    public suspend fun readFully(destination: ByteArray, offset: Int = 0, length: Int = destination.size)
     ...
     */
    public suspend fun <A : Appendable> readUTF8LineTo(out: A, limit: Int = Int.MAX_VALUE): Boolean
     ...
     * and no characters were read.
     */
    public suspend fun readUTF8Line(limit: Int = Int.MAX_VALUE): String?
